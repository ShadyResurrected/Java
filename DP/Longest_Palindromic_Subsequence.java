...
// This question is similar to that of longest common subsequence
...
//      int maxLength = FindLength(str1.length()-1,str2.length()-1,str1,str2);
    ...
    private static int FindLength(int index1, int index2, String str1, String str2) {
        // Base Case
        ...
        if(str1.charAt(index1) == str2.charAt(index2))
            return 1 + FindLength(index1-1,index2-1,str1,str2);
        return Math.max(FindLength(index1-1,index2,str1,str2),FindLength(index1,index2-1,str1,str2));
    }
